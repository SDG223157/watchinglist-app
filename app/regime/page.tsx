    ...
    <main className="max-w-[1600px] mx-auto px-4 py-8">
      <header className="mb-8 flex items-center justify-between">
        <div>
          ...
          <h1 className="text-3xl font-bold tracking-tight mt-2">Regime Card</h1>
          <p className="mt-1 text-sm" style={{ color: "var(--muted)" }}>
            Cross-sectional entropy × conditional momentum base rates. Maps the market state to a
            portfolio tilt with an empirical hit rate.
          </p>
        </div>
        {session.user.image && (
          <img
